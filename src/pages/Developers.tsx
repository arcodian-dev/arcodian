...
const mainnetEntries=[
 ...
 ["Agent Pay Factory (mainnet)","0x4E3fDc7ddA063e8d629C7140e1D7ace574275c69","Non-identity vault template, mainnet deployment. Its immutable ArcPay reference still points at the pre-2026-09-05 contract (the deployer-EOA-treasury one above) — vaultCount() is 0 on mainnet, so this has never actually settled a payment."],
