...
const mainnetEntries=[
 ...
 ["Arc Pay (mainnet)","0x69af28c7daddCFf7F9BC2DCfEd244c9696f3A9A2","Exact-value invoice settlement, deployed to Arc Mainnet. Redeployed 2026-09-05 — the original had its treasury set to the deployer EOA instead of the multisig (0.00003 USDC accrued, no real usage yet)."],
 ["Agent Pay Factory (mainnet)","0xbFb5b17daE316f1d73f8A7ED456122d132BC5DB6","Non-identity vault template, mainnet deployment. Redeployed 2026-09-05 to point at the fixed Arc Pay above — the original factory's immutable reference was stuck on the wrong-treasury contract. Old factory had vaultCount() 0, nothing to migrate."],
 ["Agent Pay Factory v6 (mainnet)","0x304f7ACFDB096358d89Da8762721207e0B5B1433","Additive ERC-1271-aware batch-payment factory. No automatic vault creation and not yet routed by the production UI. Redeployed 2026-09-05, same reason as the factory above."],
