...
export default function LendApp({ account, chainId, activeProvider, connect, disconnect }: Props) {
  ...
  return <main className="lend-site">
    <nav><a href="https://arcodian.fun" className="lend-brand"><img src="/arcodian-mark.svg" alt=""/><span>ARCODIAN<small>ARC LEND</small></span></a><div className="lend-nav-links"><a href="https://arcodian.fun/swap">Product</a><a className="active" href="/lend">Market</a><a href="https://arcodian.fun/arcpay">Pay</a><a href="https://arcodian.fun/agentpay">Agent</a><a href="/lend/admin">Admin</a></div><div className="lend-wallet"><a href="/wallet">Wallet</a><button onClick={account ? disconnect : connect}>{short(account)}</button></div></nav>
