...
export const FAQ_ITEMS = [
  ...
  ["Which wallets and networks are supported?", "Any EIP-1193 / EIP-6963 browser wallet, plus WalletConnect. Bridge, the USDC Market, Swap and StableCoin FX run on Arc Mainnet, chain 5042, with real value — connect and check the network shown before signing. StableCoin FX runs on Arc Mainnet too; EURC launches still run on Arc Testnet (chain 5042002); bridging additionally touches the supported Circle CCTP testnets/mainnets depending on which network you're on. Your keys never leave your wallet."],
];
