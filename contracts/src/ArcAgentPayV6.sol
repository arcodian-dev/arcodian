...
contract ArcAgentPayV6 {
    ...
    function isValidSignature(bytes32 hash,bytes calldata signature) external view returns(bytes4){return _recover(hash,signature)==owner?ERC1271_MAGICVALUE:ERC1271_INVALID;}
