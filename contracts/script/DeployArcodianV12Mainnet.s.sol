...
/// Arc Mainnet deploy for the V4 launch engine.
///
...
contract DeployArcodianV12Mainnet is Script {
    ...
    function run() external returns (ArcodianLaunchHook hook, ArcodianLaunchFactoryV12 factory) {
        ...
        factory = new ArcodianLaunchFactoryV12(POOL_MANAGER, hook, QUOTE, TREASURY);
        ...
        require(factory.ENGINE_VERSION() == 12, "BAD_ENGINE");
        ...
        console2.log("ArcodianLaunchFactoryV12", address(factory));
    }
}
